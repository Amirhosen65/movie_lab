@php
    $latestMovies = App\Models\Movie::where('status', true)->latest()->paginate(10);
@endphp

<section class="movie-section section--bg pb-30 pt-80 section" data-section="latest_series">
