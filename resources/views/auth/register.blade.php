...
<head>
    ...
    <title>User Register | AJ Movies</title>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                    <div class="account-form-area">
                        ...
                        <div class="text-center">
                            <h3 class="title mb-3">User Register</h3>
                        </div>
                        <form class="account-form verify-gcaptcha" action="{{ route('register') }}" method="POST">
                            @csrf
                            <div class="row ml-b-20">
                                <div class="form-group">
                                    <label>Name*</label>
                                    <input class="form-control form--control checkUser @error('name') is-invalid @enderror" id="username" name="name" type="text" value="" >
                                    @error('name')
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input class="form-control form--control @error('password_confirmation') is-invalid @enderror" id="password-confirm" name="password_confirmation" type="password" autocomplete="new-password">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <div class="checkbox-wrapper d-flex align-items-center flex-wrap">
                                            <div class="checkbox-item custom--checkbox">
                                                <input class="checkbox--input" id="agree" name="agree" type="checkbox" required>
                                                <label class="checkbox--label pe-1" for="agree">I agree with <a class="text--base" href="#" target="_blank">Terms and Condition</a></label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="account-item mt-10">
                                        <label>Already Have An Account? <a class="text--base" href="{{ route('login') }}">Login Now</a></label>
                                    </div>
                                </div>
                            </div>
                        </form>
