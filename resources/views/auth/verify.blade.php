...
<head>
    ...
    <title>Verify Your Email Address | AJ Movies</title>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                    <div class="account-form-area">
                        ...
                        <div class="text-center">
                            <h3 class="title mb-3">Verify Your Email Address</h3>
                        </div>
                        @if (session('resent'))
                    ...
                    {{ __('If you did not receive the email') }},
                        ...
                        <form class="account-form verify-gcaptcha" action="{{ route('verification.resend') }}" method="POST">
                            @csrf
