            ...
            <div class="row account-area align-items-center justify-content-center">
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                    <div class="account-form-area">
                        ...
                        <form class="account-form verify-gcaptcha" action="{{ route('password.update') }}" method="POST">
                            @csrf
                            <input type="hidden" name="token" value="{{ $token }}">
                            <div class="row ml-b-20">
                                <div class="form-group">
                                    <label>E-Mail Address*</label>
                                    <input readonly class="form-control form--control checkUser @error('email') is-invalid @enderror" id="email" name="email" type="email" value="">
                                    @error('email')
